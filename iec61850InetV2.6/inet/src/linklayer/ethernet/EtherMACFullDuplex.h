...
class INET_API EtherMACFullDuplex : public EtherMACBase
{
  ...
  protected:
    ...
    MACAddress resolveMultiMACAddress(const char *multiCastAddr);


    // statistics
    simtime_t totalSuccessfulRxTime; // total duration of successful transmissions on channel
    //Global Variables
    MACAddress multiCastMACAddrSubs[8];
    //MACAddress multiCastMACAddrGo1;
    //MACAddress multiCastMACAddrGo2;
    //MACAddress multiCastMACAddrSv1;
    //MACAddress multiCastMACAddrSv2;
};
