...
class MACAddressTable : public cSimpleModule, public IMACAddressTable
{
    ...
    public:
        ...
        /**
         * @brief It finds out if a port is assigned to a specific V-TAG
         * @param vid VLAN ID
         * @return @param list of port member of the vid
         */
         //virtual int getPortForVid(int *port, unsigned int vid = 0);
        virtual int* getPortForVid(int *numports, unsigned int vid = 0);
